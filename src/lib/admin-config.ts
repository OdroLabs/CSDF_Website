...
export const entities: EntityDef[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "author", label: "Author", type: "text", i18n: true },
      { name: "image", label: "Main image", type: "image" },
      { name: "imageAlt", label: "Main image alt text", type: "text", i18n: true },
      {
        name: "highlights",
        label: "Key points",
        type: "lines",
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "location", label: "Venue / online details", type: "text", i18n: true },
      { name: "image", label: "Main image", type: "image" },
      {
        name: "content",
        label: "Detail page content",
    ...
    listFields: [
      { name: "titleEn", label: "Title" },
      { name: "locationEn", label: "Location" },
  ...
  },
  {
    ...
    description: "Community Business catalog. Customer submissions appear under Business Orders.",
    orderBy: { order: "asc" },
    fields: [
      { name: "name", label: "Name", type: "text", i18n: true, required: true },
      { name: "category", label: "Category", type: "text", i18n: true },
      { name: "description", label: "Short description", type: "textarea", i18n: true, required: true },
      { name: "content", label: "Full description", type: "richtext", i18n: true },
      { name: "price", label: "Price (LKR)", type: "number" },
      { name: "availability", label: "Price / availability text", type: "text", i18n: true },
      { name: "image", label: "Image", type: "image" },
      { name: "imageAlt", label: "Image alt text", type: "text", i18n: true },
  ...
  {
    slug: "business-orders",
    model: "businessOrder",
    title: "Business Orders",
    titleSingular: "Business Order",
    description: "Orders submitted from the Community Business storefront.",
    readOnly: true,
