...
const content: Record<string, Val> = {
  ...
  business_ordering_title: { en: "How to Order", si: "ඇණවුම් කරන ආකාරය", ta: "எப்படி ஆர்டர் செய்வது" },
  business_ordering_steps: BLANK,
  business_payment_title: { en: "Payment", si: "ගෙවීම්", ta: "கட்டணம்" },
  business_payment_text: BLANK,
  business_delivery_title: { en: "Delivery & Collection", si: "බෙදා හැරීම සහ ලබා ගැනීම", ta: "விநியோகம் மற்றும் நேரில் பெறுதல்" },
  business_delivery_text: BLANK,
  business_policy_title: { en: "Returns & Cancellations", si: "ආපසු ලබාදීම් සහ අවලංගු කිරීම්", ta: "திருப்பி அனுப்புதல் மற்றும் ரத்துசெய்தல்" },
  business_policy_text: BLANK,
  business_impact_title: { en: "Community Impact", si: "ප්‍රජා බලපෑම", ta: "சமூகத் தாக்கம்" },
